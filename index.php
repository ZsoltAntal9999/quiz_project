    ...
    <body id="page-top">
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-2 mr-auto" id="erdekesseg_1"><img src="img/dania_kicsi.png" width="150px" height="100px" id="dania_kicsi"><label for="dania_kicsi">Dánia zászlaja a legrégebbi.</label><img src="img/svajc_kicsi.png" width="150px" height="100px" id="svajc_kicsi"><label for="svajc_kicsi">Svájc zászlaja adta a Nemzetközi Vöröskereszt zászlajának ötletét.</label><img src="img/ecuador_kicsi.png" width="150px" height="100px" id="ecuador_kicsi"><label for="ecuador_kicsi">Vannak országok, amiknek lobogóján különböző állatok láthatók, bár a legnépszerűbb a madár.</label></div>
